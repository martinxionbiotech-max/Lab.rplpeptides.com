---
description: "Strategies for difficult peptide sequences — aggregation prevention, microwave-assisted SPPS, chaotropic agents, and aspartimide control."
---
# Difficult Sequences
...
- **What Makes a Sequence Difficult?** — See the section for detailed parameters and specifications.
- **Strategies for Difficult Couplings** — Review the section above for key parameters, methods, and quality criteria.
- **How to Prevent Aspartimide Formation?** — See the section for detailed parameters and specifications.
